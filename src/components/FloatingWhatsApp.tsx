  ...
  return (
    ...
    >
      <a
        ...
        className="group relative flex items-center space-x-3 px-4 py-3 rounded-full bg-[#128C7E] hover:bg-[#075E54] text-white shadow-luxury-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-white/20"
      >
        {/* Pulse glow ripple */}
