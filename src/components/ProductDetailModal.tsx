...
export function ProductDetailModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 md:p-10 bg-black/75 backdrop-blur-md animate-fade-in"
      onClick={onClose}
    >
      <div
        className="relative w-full max-w-4xl max-h-[92vh] overflow-y-auto bg-luxury-ivory dark:bg-luxury-charcoal rounded-2xl sm:rounded-3xl border border-luxury-sand dark:border-luxury-charcoal-light shadow-2xl p-4 sm:p-8 md:p-10"
      ...
      >
        ...
        <button
          ...
          className="absolute top-3 right-3 sm:top-5 sm:right-5 z-10 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/80 dark:bg-luxury-charcoal-light/80 text-luxury-charcoal dark:text-luxury-ivory hover:text-luxury-gold flex items-center justify-center transition-colors border border-luxury-sand/50 dark:border-luxury-charcoal-light shadow-sm"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-6 flex flex-col justify-between space-y-4 sm:space-y-6">
            <div>
              <span className="text-[10px] sm:text-xs uppercase tracking-[0.2em] sm:tracking-[0.25em] text-luxury-gold font-medium block mb-1">
                {product.category}
              </span>
              <h3 className="font-serif text-xl sm:text-3xl text-luxury-charcoal dark:text-luxury-ivory font-normal">
                {product.name}
              </h3>
              <p className="text-xs sm:text-sm text-luxury-muted-light dark:text-luxury-muted-dark mt-0.5 sm:mt-1">
                {product.subtitle}
              </p>

              {/* Price */}
              <div className="mt-3 sm:mt-4 flex items-baseline space-x-2">
                <span className="font-serif text-2xl sm:text-3xl text-luxury-charcoal dark:text-luxury-gold font-normal">
                  {product.currency} {product.price.toLocaleString("es-BO")}
                </span>
                <span className="text-[11px] sm:text-xs text-luxury-muted-light dark:text-luxury-muted-dark">
                  (Incluye estuche y envío)
                </span>
              </div>

              {/* Editorial Description */}
              <p className="mt-3 sm:mt-5 text-xs sm:text-sm text-luxury-charcoal/80 dark:text-luxury-ivory/80 leading-relaxed font-light">
                {product.description}
              </p>

              {/* Specs Breakdown */}
              <div className="mt-4 sm:mt-6 space-y-1.5 sm:space-y-2.5 pt-3 sm:pt-4 border-t border-luxury-sand/60 dark:border-luxury-charcoal-light/60 text-[11px] sm:text-xs">
              ...
              <div className="mt-4 sm:mt-6">
                <span className="text-[11px] sm:text-xs uppercase tracking-wider text-luxury-charcoal dark:text-luxury-ivory font-medium block mb-2">
                ...
                <div className="flex items-center space-x-2 sm:space-x-3">
                  {product.colors.map((c) => (
                    ...
                    >
                      <span
                        className="w-5 h-5 sm:w-6 sm:h-6 rounded-full block shadow-inner border border-black/10"
            ...
            <div className="pt-3 sm:pt-4">
              <a
                ...
                className="group relative flex items-center justify-center space-x-2.5 sm:space-x-3 w-full py-3.5 sm:py-4 px-6 sm:px-8 rounded-full bg-luxury-gold text-luxury-charcoal-black font-semibold text-xs sm:text-sm uppercase tracking-[0.18em] sm:tracking-[0.2em] shadow-luxury-gold hover:shadow-luxury-gold-lg hover:bg-luxury-gold-shimmer transition-all duration-300 overflow-hidden"
              >
                <svg
              ...
              <p className="text-center text-[10px] sm:text-[11px] text-luxury-muted-light dark:text-luxury-muted-dark mt-2">
                ✦ Respuesta inmediata de una asesora de Bela Bolsa
              </p>
            </div>
          </div>
        </div>
